<template>
    <div class="top-padding">
        <div class="container mt-3">
            <h2 class="text-start mb-4 fs-5">My Wishlist <span class="text-muted">({{ items.length }} items)</span></h2>
            <div class="row row-cols-1 row-cols-md-3 row-cols-lg-4 g-3">
                <div class="col text-decoration-none text-dark" v-for="product in items" :key="product.id">
            ...
            <div class="my-5">
                <ProductsCard :products="secondaryProducts" title="CUSTOMERS ALSO VIEWED" v-observe />
            </div>
        </div>
    </div>
</template>
